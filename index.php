...
?>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-7 offset-1">
                                            <h2 style="
                                            <?php 
                                                $field = get_field('slider_color'); // dark или white
                                                if ($field == 'white') {
                                                    ?>
                                                        color: #fff;
                                                    <?php
                                            ...
                                            <?php 
                                                $field = get_field('slider_btn'); // оn или off
                                                if ($field == 'on') {
                                                    ?>
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('toys_alert_span'); ?></span> <?php the_field('toys_alert'); ?>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="contacts" id="contacts">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="contacts__descr underlined"><?php the_field('map_descr', 2); ?></div>
                    </div>
                    <div class="col-lg-6">
