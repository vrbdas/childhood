...
<html lang="ru">
	<head>
        ...
        <!-- заменить пути для изображений: echo выводит данные, bloginfo получает УРЛ директории текущей темы, и дальше путь /assets/img/-->
        <!-- в файле style.css просто заменить ../img на /assets/img и ../fonts на /assets/fonts-->
        <?php 
            wp_head(); // нужно вставлять перед </head>. обязательная строка для любой темы, чтобы добавлялись стили и скрипты
        ?>
    </head>
    <body class="no-svg">
        <header>
                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:<?php the_field('mail', 2); ?>" class="header__contacts-mail"><?php the_field('mail', 2); //вторым аргументом тут id страницы, с которой берется значение. 2 это главная страница ?></a>
                            </div>
                            <div class="header__contacts-item">
